// Clicks
export const defaultClick = document.querySelector('span[data-number="1"]');
...
// Tracks
export const memoryTrack = document.querySelector(".tracks-memory");
export const tagTrack = document.querySelector(".tracks-tags");
export const damegeTrack = document.querySelector(".tracks-damage");
export const publiTrack = document.querySelector(".tracks-publi");
...
// AIDs
export const playerAids = document.querySelectorAll("[data-aid]");
